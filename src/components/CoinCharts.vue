    ...
    <div class="info-card">
        <div class="row">
            <div class="col-12  align-items-center">
                <div class="row chart-bar">
                    <div class="chart-type">
                        <button class="btn btn-info btn-sm mr-2" :class="[{'active': chartType==='cs'}]" @click="toCandleStickChart">Candlestick Chart</button>
                        <button class="btn btn-info btn-sm" :class="[{'active': chartType==='lc'}]" @click="toLineChart">Line Chart</button>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 p-2 text-right">
                <button class="btn btn-secondary btn-sm mr-2" :class="[{'active': interval==='1h'}]" @click="updateTimeInterval('1h')">1 Hour</button>
                <button class="btn btn-secondary btn-sm mr-2" :class="[{'active': interval==='1d'}]" @click="updateTimeInterval('1d')">1 Day</button>
                <button class="btn btn-secondary btn-sm mr-2" :class="[{'active': interval==='1M'}]" @click="updateTimeInterval('1M')">1 Month</button>
            </div>
        </div>
